            ...
            <div class="d-print-none">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{url('public/dashboard')}}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('public/graphic.realtime')}}">Power Monitoring</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('public/alarm.view')}}">Static Fault</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('public/graphic.report')}}">Reporting</a>
                        </li>
                        </ul>
                    </div>
                </div>
